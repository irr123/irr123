document.addEventListener("DOMContentLoaded", function () {
  ...
  if (targetHeading) {
    ...
    iframe.src = "/text/qr-code-generator.html";
...
(function () {
    ...
    Drawing.prototype.draw = function (oQRCode) {
      ...
      svg.appendChild(
        makeSVG("rect", {
          ...
          height: "1",
          id: "template",
          "shape-rendering": "crispEdges" // https://github.com/davidshimjs/qrcodejs/pull/137/files
        })
      );
    ...
    : !_isSupportCanvas()
      ...
      : (function () {
          ...
          var Drawing = function (el, htOption) {
            ...
            el.innerHTML = ""; // https://github.com/davidshimjs/qrcodejs/pull/248/files
  ...
  function _getTypeNumber(sText, nCorrectLevel) {
    ...
    for (var i = 0, len = QRCodeLimitLength.length; i < len; i++) {
      // https://github.com/davidshimjs/qrcodejs/pull/199/files
      var nLimit = 0;
  ...
  QRCode = function (el, vOption) {
    ...
    this._el = el;
    this._oQRCode = null;
    this._oDrawing = new _drawing(this._el, this._htOption);
